...
export const MessageContent = ({
	...
	<div
		className={cn(
			...
			"group-[.is-user]:ml-auto group-[.is-user]:rounded-xl group-[.is-user]:bg-black/5 group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-foreground dark:group-[.is-user]:bg-white/10",
